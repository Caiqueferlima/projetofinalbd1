...
-- Tabela Compra_Venda
INSERT INTO Compra_Venda (ID_venda, Data_venda, Valor_total, Produtos, Forma_pagamento) 
VALUES 
    (1, '2024-11-20', 150.75, 'Arroz', 'Dinheiro'),
    (2, '2024-10-21', 200.50, 'Feijão', 'Cartão de Crédito'),
    (3, '2024-09-22', 320.00, 'Óleo', 'Cartão de Débito'),
    (4, '2024-10-23', 150.25, 'Shampoo', 'Dinheiro'),
    (5, '2024-11-24', 250.75, 'Manteiga', 'PIX');
